def build_rag_prompt(query: str, retrieved_chunks: list[dict], chat_history: str = "") -> str:
    """
    Constructs the final prompt string that gets fed to the LLM.
    It combines the chat history (if any), the retrieved chunks, and the user's query.
    """
